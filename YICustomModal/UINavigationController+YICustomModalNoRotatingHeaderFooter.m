//
//  UINavigationController+YICustomModalNoRotatingHeaderFooter.m
//  YICustomModal
//
...
@implementation UINavigationController (YICustomModalNoRotatingHeaderFooter)
...
+ (void)load
{
    [UINavigationController yi_swizzleSelector:@selector(rotatingHeaderView) withSelector:@selector(yi_rotatingHeaderView)];
    [UINavigationController yi_swizzleSelector:@selector(rotatingFooterView) withSelector:@selector(yi_rotatingFooterView)];
}
